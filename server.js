...
var connector = new builder.ChatConnector({
    appId: process.env.MICROSOFT_APP_ID || 'eacda2ac-d548-48a8-9231-850ba1dc4225',
    appPassword: process.env.MICROSOFT_APP_PASSWORD || 'ku3PXVaSc9LPBTOxnOqWi4r'
});
var bot = new builder.UniversalBot(connector);
// If a Post request is made to /api/messages on port 3978 of our local server, then we pass it to the bot connector to handle
server.post('/api/messages', connector.listen());

var luisRecognizer = new builder.LuisRecognizer('https://westus.api.cognitive.microsoft.com/luis/v2.0/apps/ac6cf7eb-baed-4a6b-8c5d-b6dfd65a0803?subscription-key=5fdda394dde44e499305b06cfb23613a');
